...
function GalleryItem({ Data, refInfo, isLast }) {
  ...
  return (
    <div
      ...
      ref={isLast ? refInfo : null}
      className="rounded-md font-semibold overflow-hidden hover:shadow-lg mx-auto  w-full "
    >
      <img
        className="w-full"
        src={Data.urls.small}
      ...
      />
      <div className="flex justify-between px-3 py-2 border-x border-b rounded-b-md  border-slate-200  ">
